...
<body>
  ...
  ?>
    ...
    <img src="img/receiver.png" class="border rounded-circle text-center border-dark" height="60" width="60" alt="">
                ...
                <h1 class="h3  font-weight-normal text-center">Register as Receiver</h1>
                ...
                <form class="d-flex flex-column form-signin" method="post">
                    ...
                    <div class="form-signin form-group">
                        <label for="psupplier">Blood Group</label>
                        <select class="form-select required" id="blood_group">
                    ...
                    <div class="form-signin form-group">
                        ...
                        <input type="text" class="form-control fields" id="location" name="location"
                            onkeyup="ValidateLocation();" required placeholder="Your location">
                        <span id="error_location" class="text-danger text-success error_fields"></span>
                    </div>
                    <button type="button" name="submit" id="submit" onclick='form_login()'
    ...
    function form_login() {
        ...
        if (frm_error == '') {
            ...
            $.ajax({
                url: "ajax-register-receiver-validate.php",
                type: "POST",
